...
fully independent and 100% tolerant to incorrect subscriber's behaviour, or to implement 100% robust subscriber's logic.
 ...
 * TODO (maybe): you can use internal RaiseAsync and RaiseAsyncWait methods to simplify async event raise implementation.
